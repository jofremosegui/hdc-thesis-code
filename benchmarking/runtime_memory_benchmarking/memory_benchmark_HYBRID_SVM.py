...
def main():
    INPUT_SHAPE = (1, 800, 7)
    ENCODER_PATH = "results/HDC_HYBRID_SVM/20250510_235143/encoder.pt"  # Update this
    CLASSIFIER_PATH = "results/HDC_HYBRID_SVM/20250510_235143/SVM_model.pkl"  # Update this
